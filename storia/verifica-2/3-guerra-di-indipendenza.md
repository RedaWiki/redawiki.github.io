...
Uno dei più importanti esponenti della Destra storica fu Marco Minghetti che sostituì Cavour nella guida della Destra storica.
...
Come conseguenza tra la popolazione sfocia l'illegalità chiamata "Brigantaggio", ovvero razzie, furti e uccisioni.
...
La Destra storica ha anche come obbiettivo il pareggio di bilancio, cioè entrate, uscite e debito dello stato pari a 0.
Per raggiungerlo aumentarono le tasse e imposte.

Nel 1868 impongono anche la tassa sul macinato (ceriali) dato che è la maggior attività in tutta italia, creando però tanta povertà.

C'è ancora un altro obbiettivo che la Destra storica vuole raggiungere, ovvero l'unità nazionale.
...
Nel 1862 Guglielmo I nomina come primo ministro Otto Von Bismark, il suo primo atto è quello di sciogliere le camere (vengono destituite) per mettere in atto le riforme economiche di Guglielmo I.
...
Nel 1866 la Prussia insieme all'Italia (che vuole riprendersi il veneto) dichiara guerra all'Austria, che si trova a cercare degli alleati all'interno della confederazione negli altri stati tedeschi.
Qualche mese dopo la Prussia sconfigge l'Austria, l'Italia viene sconfitta ma riesce ad ottenere il Veneto (3° Guerra di indipendenza).
